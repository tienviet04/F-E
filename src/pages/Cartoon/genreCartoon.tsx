...
import { getMoviesCartoonPaginated } from "../../api/movies";
import ReactPaginate from "react-paginate";
import "./genreCartoon.css";
import Carouseled from "../../components/carousel/silcarousel";

export default function GenreCartoon() {
    ...
    const handlePageChange = async (selectedItem: { selected: number }) => {
        ...
        const { data, totalPages, currentPage } = await getMoviesCartoonPaginated(
            newPage,
            10
        );
        setMoviesList(data);
            ...
            <div className="max-w-screen-xl mx-auto">
                <div className="pb-24">
                    <div className="flex justify-between items-center">
                        <p className="text-white text-4xl font-bold">Phim hoạt hình</p>
                    </div>
